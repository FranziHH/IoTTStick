...
def release_action(env, target, source):
    ...
    files_to_copy = [
        ...
        (full_bin_src, "LNFP_M5Stick_Plus2_Full.bin")
    ]
    ...
    if os.path.exists(json_path):
        ...
        full_id = f"V{version}/{destPath}/LNFP_M5Stick_Plus2_Full.bin"
        app_id = f"V{version}/{destPath}/LNFP_M5Stick.ino.bin"

        # Check für FULL
        if os.path.exists(os.path.join(output_dir, "LNFP_M5Stick_Plus2_Full.bin")):
